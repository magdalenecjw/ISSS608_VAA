...
pop_pyramid <- pop_data %>%
  ...
  scale_y_continuous(breaks = seq(-150000, 150000, 50000), 
                     labels = paste0(as.character(c(seq(150, 0, -50), 
                                                    seq(50, 150, 50))),
                                     "k")) +
  labs(title = "Across all Planning Areas", 
       x = "Age Groups", y = "Total Population") + 
...
facet_pyramid <- facet_pyramid_data %>%
  ...
  labs(title = "Top 9 Most Populous Planning Areas", 
       x = "", y = "Population by Planning Area") +
...
```{r, fig.width=12,fig.height=6}
#Combine both plots
patchwork <- pop_pyramid + facet_pyramid

patchwork + plot_annotation(
  title = "Age-Sex Pyramid for Singapore as of June 2022",
